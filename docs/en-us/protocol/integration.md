...
@default 0
@optional
Fork extension. Use an Expedited Plan only when the confirmed minimum recruitment rarity is at least this value. `0` preserves the original behavior; supported thresholds are `4`, `5`, and `6`.
:::
::: field skip_robot  
@type boolean
@default true
